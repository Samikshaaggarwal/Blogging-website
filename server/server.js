...
import serviceAccountKey from "./reactjs--blogging-website-firebase-adminsdk-frost-083cb83d8d.json" assert{ type: "json" }
...
server.get("/trending-blogs", (req, res) => {
    Blog.find({ draft: false })
        .populate("author", "personal_info.profile_img personal_info.username personal_info.fullname -_id")
        .sort({ "activity.total_read": -1, "activity.total_likes": -1, "publishesAt": -1 })
